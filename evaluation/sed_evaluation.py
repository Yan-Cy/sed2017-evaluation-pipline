...
validator_path = '/mnt/sdc/chenyang/F4DE/TrecVid08/tools/TV08ViperValidator/TV08ViperValidator.pl'
...
def xml_script(validator_path):
    outfile = 'gen.sh'
    outdir = 'xml/'
    detdir = 'csv/'
    templatedir = os.path.join('xmltemplate/*.xml')

    with open(outfile, 'w') as f:
        empty_cmd = [validator_path,
...
def gtf_script(validator_path):
    outfile = 'gtf_gen.sh'
    outdir = 'gtf_xml/'
    detdir = 'gtf_csv/'
    templatedir = os.path.join('gtf_template/*.xml')
...
if __name__ == '__main__':
    prepare_csv()
    #prepare_csv_3phases()
    xml_script(validator_path)
    #prepare_gtf()
    #gtf_script(validator_path)
    exp_control()
